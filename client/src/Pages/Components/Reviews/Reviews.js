                        ...
                        return (
                            <div className="rev-content" onClick={() => (window.location.href = item.AffiliatedLink ? item.AffiliatedLink : '#')} key={id}>
                                <div className="rev-icon-star">
                                    <img src={item.Logo ? item.Logo : 'https://play-lh.googleusercontent.com/dsCkmJE2Fa8IjyXERAcwc5YeQ8_NvbZ4_OI8LgqyjILpXUfS5YhEcnAMajKPrZI-og'} alt="" style={{width:"65px", height:"65px"}}/>
                                    <Rating
                                        name="read-only"
                                        size="large" 
                                        value={item.Rating}
